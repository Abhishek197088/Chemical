      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-white flex items-center gap-2">
            <Layers className="h-8 w-8 text-primary" /> Stock movement manager
          </h1>
          <p className="text-muted-foreground mt-1">
            Audit chemical stock shifts, adjust inventory levels, and manually restock items.
          </p>
        </div>
            ...
            <form onSubmit={handleAdjustSubmit}>
              <CardContent className="space-y-4">
                ...
                <div className="space-y-1.5">
                  <label className="text-[10px] uppercase font-bold tracking-wider text-muted-foreground">Select Chemical</label>
                ...
                <div className="space-y-1.5">
                  ...
                  {selectedProduct && (
                    <span className="text-[9px] text-muted-foreground leading-normal block">
                      Note: You are adjusting the stock in {selectedProduct.baseUnit === "kg" || selectedProduct.baseUnit === "g" ? "grams" : selectedProduct.baseUnit === "L" || selectedProduct.baseUnit === "mL" ? "milliliters" : "items"}. E.g. 1,000 = 1 kg/L.
                    </span>
                  )}
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <Select value={adjustType} onChange={(e) => setAdjustType(e.target.value)} required>
                    ...
                    <option value="ADJUSTMENT">ADJUSTMENT (Audit adjustment)</option>
                  </Select>
                </div>
